...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'nexopos_orders' ) ) {
            Schema::create( 'nexopos_orders', function( Blueprint $table ) {
        ...
        if ( ! Schema::hasTable( 'nexopos_orders_count' ) ) {
            Schema::create( 'nexopos_orders_count', function( Blueprint $table ) {
                $table->bigIncrements( 'id' );
                $table->integer( 'count' );
                $table->datetime( 'date' );
            });
        ...
        if ( ! Schema::hasTable( 'nexopos_orders_taxes' ) ) {
            Schema::create( 'nexopos_orders_taxes', function( Blueprint $table ) {
                $table->bigIncrements( 'id' );
    ...
    {
        if ( Schema::hasTable( 'nexopos_orders' ) ) {
            Schema::drop( 'nexopos_orders' );
        }

        if ( Schema::hasTable( 'nexopos_orders_count' ) ) {
            Schema::drop( 'nexopos_orders_count' );
        }

        if ( Schema::hasTable( 'nexopos_orders_taxes' ) ) {
            Schema::drop( 'nexopos_orders_taxes' );
        }
    }
}
