    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'nexopos_products_unit_quantities' ) ) {
            Schema::createIfMissing( 'nexopos_products_unit_quantities', function ( Blueprint $table ) {
                ...
                $table->float( 'sale_price_net', 18, 5 )->default( 0 ); // must be computed automatically
                $table->float( 'sale_price_gross', 18, 5 )->default( 0 ); // must be computed automatically
                ...
                $table->float( 'wholesale_price_gross', 18, 5 )->default( 0 ); // include tax whole sale price
                $table->float( 'wholesale_price_net', 18, 5 )->default( 0 ); // exclude tax whole sale price
                ...
                $table->float( 'custom_price_gross', 18, 5 )->default( 0 );
                $table->float( 'custom_price_net', 18, 5 )->default( 0 );
