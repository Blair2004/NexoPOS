    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'nexopos_products' ) ) {
            Schema::create( 'nexopos_products', function( Blueprint $table ) {
                ...
                $table->integer( 'selling_unit_id' )->nullable();
                $table->integer( 'purchase_unit_id' )->nullable();
                $table->integer( 'transfer_unit_id' )->nullable();
                $table->string( 'selling_unit_type' )->default( 'unit' )->nullable(); // could be either unit or unit-group
                $table->string( 'purchase_unit_type' )->default( 'unit' )->nullable(); // could be either unit or unit-group
                $table->string( 'transfer_unit_type' )->default( 'unit' )->nullable(); // could be either unit or unit-group
