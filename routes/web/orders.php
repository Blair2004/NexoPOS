...
Route::get( '/orders/assignated', [ OrdersController::class, 'listAssignatedOrders' ] )->name( ns()->routeName( 'ns.dashboard.orders-assignated' ) )->middleware( NsRestrictMiddleware::arguments([ 'nexopos.deliver.orders' ]) );
