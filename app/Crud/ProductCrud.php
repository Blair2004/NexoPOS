...
class ProductCrud extends CrudService
{
    ...
    public function __construct()
    {
        ...
        $this->registerBulkEditingFields();
    }
    ...
    /**
     * Register Bulk Editing Fields
     */
    public function registerBulkEditingFields(): void
    {
        if ( class_exists( ConfigurationService::class ) ) {
            ...
            $configuration->register( 
                class: self::class, 
                configuration: BulkEdit::configuration(
