<template>
    <div class="flex flex-auto flex-col shadow rounded-lg overflow-hidden">
        ...
        <div class="p-2 bg-white -mx-4 flex flex-wrap">
            <div class="flex w-full md:w-1/2 lg:w-full xl:w-1/2 lg:border-b lg:border-t border-gray-200 lg:py-1 lg:my-1">
                <div class="px-4 w-1/2 lg:w-1/2 flex flex-col items-center justify-center">
                    ...
                    <h2 class="text-lg lg:text-3xl text-gray-700 font-bold">{{ totalWeeklySales | currency( 'abbreviate' ) }}</h2>
                </div>
                <div class="px-4 w-1/2 lg:w-1/2 flex flex-col items-center justify-center">
                    <span class="text-xs text-gray-600">Week Taxes</span>
                    <h2 class="text-lg lg:text-3xl text-gray-700 font-bold">{{ totalWeekTaxes | currency( 'abbreviate' ) }}</h2>
                </div>
            </div>
            <div class="flex w-full md:w-1/2 lg:w-full xl:w-1/2">
                <div class="px-4 w-full lg:w-1/2 flex flex-col items-center justify-center">
                    ...
                    <h2 class="text-lg lg:text-3xl text-gray-700 font-bold">{{ totalWeekIncome | currency( 'abbreviate' ) }}</h2>
                </div>
                <div class="px-4 w-full lg:w-1/2 flex flex-col items-center justify-center">
                    <span class="text-xs text-gray-600">Week Expenses</span>
                    <h2 class="text-lg lg:text-3xl text-gray-700 font-bold">{{ totalWeekExpenses | currency( 'abbreviate' ) }}</h2>
                </div>
            </div>
        </div>
    </div>
