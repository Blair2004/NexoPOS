            ...
            <div class="table w-full my-4">
                <table class="table w-full">
                    <thead class="text-gray-600 bg-gray-100">
                        <tr>
                            <th width="400" class="p-2 border border-gray-200">Product</th>
                            <th width="200" class="p-2 border border-gray-200">Unit Price</th>
                            <th width="200" class="p-2 border border-gray-200">Quantity</th>
                            <th width="200" class="p-2 border border-gray-200">Discount</th>
                            <th width="200" class="p-2 border border-gray-200">Tax</th>
                            <th width="200" class="p-2 border border-gray-200">Total Price</th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <tfoot class="font-semibold bg-gray-100">
                        <tr>
                            ...
                            <td class="p-2 border border-gray-200 text-gray-700 text-left">Sub Total</td>
                        ...
                        <tr>
                            ...
                            <td class="p-2 border border-gray-200 text-gray-700 text-left">Discount</td>
                            <td class="p-2 border border-gray-200 text-right text-gray-700">{{ order.discount | currency }}</td>
                        </tr>
                        <tr>
                            <td class="p-2 border border-gray-200 text-center text-gray-700" colspan="4"></td>
                            <td class="p-2 border border-gray-200 text-gray-700 text-left">Shipping</td>
                            <td class="p-2 border border-gray-200 text-right text-gray-700">{{ order.shipping | currency }}</td>
                        </tr>
                        <tr>
                            <td class="p-2 border border-gray-200 text-center text-gray-700" colspan="4"></td>
                            <td class="p-2 border border-gray-200 text-gray-700 text-left">Total</td>
                            <td class="p-2 border border-gray-200 text-right text-gray-700">{{ order.total | currency }}</td>
                        </tr>
                        <tr>
                            <td class="p-2 border border-gray-200 text-center text-gray-700" colspan="4"></td>
                            <td class="p-2 border border-gray-200 text-gray-700 text-left">Paid</td>
                        ...
                        <tr v-if="[ 'partially_paid', 'unpaid' ].includes( order.payment_status )" class="bg-red-200 border-red-300">
                            ...
                            <td class="p-2 border border-red-200 text-red-700 text-left">Due</td>
                            <td class="p-2 border border-red-200 text-right text-red-700">{{ order.change | currency }}</td>
                        </tr>
                        <tr v-else>
                            <td class="p-2 border border-gray-200 text-center text-gray-700" colspan="4"></td>
                            <td class="p-2 border border-gray-200 text-gray-700 text-left">Change</td>
