<template>
    <div class="bg-white rounded shadow my-2 overflow-hidden">
        <div class="welcome-box border-b border-gray-300 p-3 text-gray-700">
            <p class="text-gray-600 text-sm">{{ __( 'Thank you for having chosen NexoPOS for managing your store. This is the installation wizard that will guide you through the installation.' ) }}</p>
            <div class="py-2">
