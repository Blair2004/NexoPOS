<template>
    <div class="bg-surface-tertiary shadow-lg w-95vw h-95vh md:w-2/5-screen overflow-hidden md:h-5/6-screen flex flex-col">
        ...
        <div class="p-2 border-b border-surface-secondary flex-auto overflow-y-auto">
