<template>
    <div id="popup" :class="size" class="w-5/7-screen md:w-3/7-screen flex flex-col bg-surface-tertiary shadow-lg">
        ...
        <div class="p-2">
            <textarea v-model="input" name="" id="" cols="30" rows="10" class="text-primary w-full border-2 p-2 border-info-primary"></textarea>
        </div>
        <div class="flex border-t border-surface-secondary text-primary">
