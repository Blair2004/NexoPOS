...
const nsTextarea    =   Vue.component( 'ns-textarea', {
    ...
    computed: {
        ...
        disabledClass() {
            return this.field.disabled ? 'ns-disabled cursor-not-allowed' : 'ns-enabled bg-transparent';
        },
        inputClass() {
    ...
    <div class="flex flex-col mb-2 flex-auto ns-textarea">
        ...
        <div :class="hasError ? 'has-error' : 'is-pristine'" class="mt-1 relative border-2 rounded-md focus:shadow-sm mb-2">
