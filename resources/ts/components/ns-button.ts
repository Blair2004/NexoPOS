...
const nsButton      =   Vue.component( 'ns-button', {
    ...
    template: `
    <div class="flex ns-button rounded overflow-hidden" :class="type ? type : 'default'" @click="$emit( 'click' )">
        <button :disabled="isDisabled" v-if="!link" class="flex rounded items-center cursor-pointer py-2 px-3 font-semibold"><slot></slot></button>
