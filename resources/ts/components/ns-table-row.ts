    ...
    <tr class="ns-table-row" :class="row.$cssClass ? row.$cssClass : 'border text-sm'">
        ...
        <td v-if="prependOptions" class="font-sans p-2">
            <div class="flex items-center justify-center">
                ...
                <div class="relative">
                    <div v-if="row.$toggled" class="zoom-in-entrance border border-box-edge anim-duration-300 z-50 origin-bottom-right -ml-32 w-56 mt-2 absolute rounded-md shadow-lg ns-menu-wrapper">
