...
const nsDate        =   Vue.component( 'ns-date', {
    ...
    <div class="flex flex-auto flex-col mb-2">
        ...
        <div :class="hasError ? 'border-error-primary' : 'border-surface-primary'" class="bg-surface-tertiary text-secondary mt-1 relative border-2 rounded-md focus:shadow-sm">
