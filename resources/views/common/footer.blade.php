...
$json               =   [
    ...
    'ns_currency_iso'                   =>  $options->get( 'ns_currency_iso', '$' ),
    'ns_currency_position'              =>  $options->get( 'ns_currency_position', '$' ),
    ...
    'ns_currency_precision'             =>  $options->get( 'ns_currency_precision', '$' ),
];
?>
