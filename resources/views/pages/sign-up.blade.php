            ...
            <div id="sign-in-box" class="w-full md:w-1/3">
                <div class="bg-white p-3 rounded shadow -my-2">
                    <div class="form-field flex flex-col my-2">
                        <label for="" class="font-semibold text-sm mb-1">{{ __( 'Username' ) }}</label>
                    ...
                    <div class="flex justify-between items-center my-2">
                        <div>
                            <a href="{{ url( '/sign-in' ) }}" class="hover:underline text-blue-600 text-sm">Already registered ?</a>
                        </div>
                        <div class="flex -mx-2">
                            <div class="px-2">
                                <button class="text-center rounded shadow border border-blue-600 w-24 bg-blue-400 text-white py-1 px-3">Register</button>
                            </div>
                        </div>
                    </div>
                </div>
