                        ...
                        <div class="my-4 flex justify-between w-full">
                            <div class="text-primary">
                                <ul>
                                    ...
                                    <li class="pb-1 border-b border-dashed border-surface-secondary">{{ __( 'Document : Sale Report' ) }}</li>
                            ...
                            <table class="ns-table table w-full">
                                <thead class="">
                                    <tr>
                                        ...
                                        <th width="150" class="border border-error-secondary bg-error-primary p-2 text-right">Debit</th>
                                        <th width="150" class="text-right border-success-secondary bg-success-primary border p-2">Credit</th>
                                    </tr>
                                </thead>
                                <tbody class="">
